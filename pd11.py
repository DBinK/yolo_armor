...
# 打印结果
print(f"处理帧数: {frame_count} - {skip_frames} = {frame_count-skip_frames}")
print(f"总有效推理时间: {spend_time:.4f} 秒")
print(f"平均推理时间: {average_inference_time*1000:.2f} ms")
print(f"平均帧率: {fps:.2f} FPS")
print(f"识别到 目标 的次数: {tg_count}")
